...
> {
  public async onExecute(args: RequestSelfIntroArgs) {
    await app.client.chat.postEphemeral({
      ...
      text: `Hey, it looks like you have not completed your self-intro yet. Please take this time to introduce yourself to the community in the <#${CHANNEL_ID_SELF_INTRO}> channel.`,
    });
  }
}
